...
<body>
		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1><spring:message code="label.artist.update.page.title"/></h1>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="basic-login">
							<c:url var="updateUrl" value="/artist/update" />
							<form:form action="${updateUrl }" commandName="artist" method="POST" cssClass="forms contact-form" enctype="multipart/form-data">
								...
								<div class="form-group control-group">
									...
									<img alt="" src="${artist.avatarThumbnailUrl }">
								...
								<div class="form-group control-group">
		        				 	...
		        				 	<img alt="" src="${artist.pageCoverThumbnailurl }">
								...
								<div class="form-group">
									<div class="pull-right">
										...
										<button id="add-artist-button" type="submit" class="btn btn-primary">
											<spring:message code="label.update.artist.button"/>
										</button>
									</div>
