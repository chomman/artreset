...
public class ArtresetApplicationConfig implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        //FilterRegistration.Dynamic hibernateSessionFilter = servletContext.addFilter("hibernateSessionFilter", new OpenSessionInViewFilter());
        //hibernateSessionFilter.addMappingForUrlPatterns(dispatcherTypes, true, "/*");
