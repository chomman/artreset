...
<html>
	<head>
		...
		<!-- Bootstrap Core CSS -->
		<link href="<c:url value="/assets/theme/reen/css/bootstrap.min.css"/>" rel="stylesheet">
		
		<!-- Customizable CSS -->
		<link href="<c:url value="/assets/theme/reen/css/main.css"/>" rel="stylesheet" data-skrollr-stylesheet>
		<link href="<c:url value="/assets/theme/reen/css/green.css"/>" rel="stylesheet" title="Color">
		<link href="<c:url value="/assets/theme/reen/css/owl.carousel.css"/>" rel="stylesheet">
		<link href="<c:url value="/assets/theme/reen/css/owl.transitions.css"/>" rel="stylesheet">
		<link href="<c:url value="/assets/theme/reen/css/animate.min.css"/>" rel="stylesheet">
		...
		<!-- Icons/Glyphs -->
		<link href="<c:url value="/assets/theme/reen/fonts/fontello.css"/>" rel="stylesheet">
		
		<!-- Favicon -->
		<link rel="shortcut icon" href="<c:url value="/assets/theme/reen/images/favicon.ico"/>">
		
		<!-- HTML5 elements and media queries Support for IE8 : HTML5 shim and Respond.js -->
		<!--[if lt IE 9]>
			<script src="<c:url value="/assets/theme/reen/js/html5shiv.js"/>"></script>
			<script src="<c:url value="/assets/theme/reen/js/respond.min.js"/>"></script>
		<![endif]-->
		
		<!-- JavaScripts placed at the end of the document so the pages load faster -->
		<script src="<c:url value="/assets/theme/reen/js/jquery-1.11.1.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/jquery.easing.1.3.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/bootstrap.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/bootstrap-hover-dropdown.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/skrollr.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/skrollr.stylesheets.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/waypoints.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/waypoints-sticky.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/owl.carousel.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/jquery.isotope.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/jquery.easytabs.min.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/jquery.slickforms.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/google.maps.api.v3.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/viewport-units-buggyfill.js"/>"></script>
		<script src="<c:url value="/assets/theme/reen/js/scripts.js"/>"></script>
		
		<!-- For demo purposes – can be removed on production -->
		<link href="<c:url value="/assets/theme/reen/css/green.css"/>" rel="alternate stylesheet" title="Green color">
		<link href="<c:url value="/assets/theme/reen/css/blue.css"/>" rel="alternate stylesheet" title="Blue color">
		<link href="<c:url value="/assets/theme/reen/css/red.css"/>" rel="alternate stylesheet" title="Red color">
		<link href="<c:url value="/assets/theme/reen/css/pink.css"/>" rel="alternate stylesheet" title="Pink color">
		<link href="<c:url value="/assets/theme/reen/css/purple.css"/>" rel="alternate stylesheet" title="Purple color">
		<link href="<c:url value="/assets/theme/reen/css/orange.css"/>" rel="alternate stylesheet" title="Orange color">
		<link href="<c:url value="/assets/theme/reen/css/navy.css"/>" rel="alternate stylesheet" title="Navy color">
		<link href="<c:url value="/assets/theme/reen/css/gray.css"/>" rel="alternate stylesheet" title="Gray color">
			...
			<div class="navbar">
				...
				<div class="navbar-header">
					<div class="container">
						...
						<a class="navbar-brand" href="index.html"><img src="<c:url value="/assets/theme/reen/images/logo.svg"/>" class="logo" alt=""></a>
												...
												<div class="col-sm-3 inner">
													...
													<figure>
														<div class="icon-overlay icn-link">
															<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work01.jpg"/>" alt=""></a>
														</div>
														<figcaption>
													...
													<div class="row thumbs gap-xs">
														...
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work02.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
														
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work03.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
														
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work04.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
														
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work05.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
														
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work06.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
														
														<div class="col-xs-6 thumb">
															<figure class="icon-overlay icn-link">
																<a href="portfolio-post.html"><img src="<c:url value="/assets/theme/reen/images/art/work07.jpg"/>" alt=""></a>
															</figure>
														</div><!-- /.thumb -->
			...
			<div class="container inner">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 inner">
						<h4>Who we are</h4>
						<a href="index.html"><img class="logo img-intext" src="<c:url value="/assets/theme/reen/images/logo-white.svg"/>" alt=""></a>
