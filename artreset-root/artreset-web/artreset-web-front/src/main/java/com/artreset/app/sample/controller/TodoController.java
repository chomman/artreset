...
/**
 * Artreset Project의 Application 개발 샘플로 제작한 Controller<br>
 * 일반적인 경우, 웹작업 Controller의 코딩구조 및 스타일 등은 이를 모델로 삼는다.
 * 
 * @author Taehyun Jung
 */
@Controller
...
public class TodoController extends BaseController {
    ...
    protected static final String VIEW_TODO_ADD 	= "sample/todo/add";
    protected static final String VIEW_TODO_LIST 	= "sample/todo/list";
    protected static final String VIEW_TODO_UPDATE 	= "sample/todo/update";
    protected static final String VIEW_TODO_VIEW 	= "sample/todo/view";
