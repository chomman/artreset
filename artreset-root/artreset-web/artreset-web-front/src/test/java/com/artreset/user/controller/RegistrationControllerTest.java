...
import static com.artreset.user.controller.TestProviderSignInAttemptAssert.assertThatSignIn;
import static com.artreset.user.dto.RegistrationFormAssert.assertThatRegistrationForm;
...
import com.artreset.WebTestConstants;
...
public class RegistrationControllerTest {
    ...
    public void showRegistrationForm_NormalRegistration_ShouldRenderRegistrationPageWithEmptyForm() throws Exception {
        mockMvc.perform(get("/user/register"))
                ...
                .andExpect(forwardedUrl("/WEB-INF/views/user/registrationForm.jsp"))
